...
class DerenzoPhantom(object):
    ...
    def to_image(self, img_side, num_events=1., event_mode="equal_counts", plot=False):
        ...
        Event mode determines how many events per well. Options are as above.
        """
        ...
        for section in self.sections:
            ...
            if event_mode == 'equal_activity': activity = section.well_area
    ...
    def mm_to_px(self, xy, shp, radius, round=False):
        """
        Internal to change from mm coords to image pixels.
        """
